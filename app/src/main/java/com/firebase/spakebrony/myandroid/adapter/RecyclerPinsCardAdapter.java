...
import com.firebase.spakebrony.myandroid.utilities.CompatUtils;
import com.firebase.spakebrony.myandroid.utilities.ImageLoadBuilder;
import com.firebase.spakebrony.myandroid.utilities.Utils;
...
//        }
    ...
    private void onBindData(final ViewHolder holder, PinsMainEntity bean) {
        ...
        String url_img= bean.getFile_url();

//        String mImageUrl = "http://img.hb.aicdn.com/1d16a79ac7cffbec844eb48e7e714c9f8c0afffc7f997-ZZCJsm";

        float ratio = Utils.getAspectRatio(bean.getFile_url_w(), bean.getFile_url_h());
